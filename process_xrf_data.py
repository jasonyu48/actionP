...
def process_xrf_data():
    ...
    base_dir = '/weka/scratch/rzhao36/lwang/datasets/HOI/datasets/xrf55'
    # Output directory for processed data
    output_base_dir = 'xrf555_processed_multi_angle'
    ...
    for action_type in action_types:
        ...
        for angle in angle_folders:
            ...
            # Create output angle directory if it doesn't exist
