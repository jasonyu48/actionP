...
def main():
    ...
    # Create datasets
    train_dataset = LWDataset(base_dir=args.data_dir, split='train', use_multi_angle=args.use_multi_angle)
    val_dataset = LWDataset(base_dir=args.data_dir, split='val', use_multi_angle=args.use_multi_angle)
